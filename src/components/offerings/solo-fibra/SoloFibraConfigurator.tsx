...
import { WifiHigh, Broadcast } from '@phosphor-icons/react';
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="space-y-4">
                <div>
                  <div className="text-sm text-gray mb-1">Velocidad</div>
                ...
                <div className="flex items-center gap-2 text-[#79C4CD]">
                  ...
                  <span className="text-sm text-gray">Router WiFi 6</span>
                </div>
